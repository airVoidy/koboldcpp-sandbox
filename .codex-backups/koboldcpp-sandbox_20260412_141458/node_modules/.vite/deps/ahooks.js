import {
  ...
  __spreadArray,
  __values
} from "./chunk-FUGPTEDR.js";
import {
  require_react
} from "./chunk-SUHFC5XY.js";
import {
  __commonJS,
  __toESM
...
var useMemoizedFn = function(fn) {
  ...
  var memoizedFn = (0, import_react2.useRef)(void 0);
...
var setCache = function(key, cacheTime, cachedData) {
  ...
  cache.set(key, __assign(__assign({}, cachedData), { timer }));
};
...
var useCachePlugin = function(fetchInstance, _a) {
  ...
  var unSubscribeRef = (0, import_react8.useRef)(void 0);
  var currentPromiseRef = (0, import_react8.useRef)(void 0);
...
var useDebouncePlugin = function(fetchInstance, _a) {
  ...
  var debouncedRef = (0, import_react9.useRef)(void 0);
...
var useLoadingDelayPlugin = function(fetchInstance, _a) {
  ...
  var timerRef = (0, import_react10.useRef)(void 0);
  if (!loadingDelay) {
    return {};
  }
...
var usePollingPlugin = function(fetchInstance, _a) {
  ...
  var timerRef = (0, import_react11.useRef)(void 0);
  var unsubscribeRef = (0, import_react11.useRef)(void 0);
...
var useRefreshOnWindowFocusPlugin = function(fetchInstance, _a) {
  ...
  var unsubscribeRef = (0, import_react12.useRef)(void 0);
...
var useRetryPlugin = function(fetchInstance, _a) {
  ...
  var timerRef = (0, import_react13.useRef)(void 0);
...
var useThrottlePlugin = function(fetchInstance, _a) {
  ...
  var throttledRef = (0, import_react14.useRef)(void 0);
  var options = {};
...
var useUpdate = function() {
  ...
  return useMemoizedFn_default(function() {
    return setState({});
  });
};
...
var Fetch = (
  ...
  function() {
    function Fetch2(serviceRef, options, subscribe4, initState3) {
      ...
      this.state = __assign(__assign(__assign({}, this.state), { loading: !options.manual }), initState3);
    }
        ...
        return __generator(this, function(_q) {
          switch (_q.label) {
            case 0:
              ...
              this.setState(__assign({ loading: true, params }, state));
              if (returnNow) {
                return [2, Promise.resolve(state.data)];
              }
...
function useRequestImplement(service, options, plugins) {
  ...
  var fetchInstance = useCreation_default(function() {
...
var usePagination = function(service, options) {
  ...
  var result = useRequest_default2(service, __assign({ defaultParams: [{ current: defaultCurrent, pageSize: defaultPageSize }], refreshDepsAction: function() {
    changeCurrent(1);
  } }, rest));
...
var useAntdTable = function(service, options) {
  ...
  var result = usePagination_default(service, __assign(__assign({ ready, manual: true }, rest), { onSuccess: function() {
    var _a2;
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
      args[_i] = arguments[_i];
  ...
  var reset = function() {
    ...
    _submit(__assign(__assign({}, (defaultParams === null || defaultParams === void 0 ? void 0 : defaultParams[0]) || {}), { pageSize: options.defaultPageSize || ((_b2 = (_a2 = options.defaultParams) === null || _a2 === void 0 ? void 0 : _a2[0]) === null || _b2 === void 0 ? void 0 : _b2.pageSize) || 10, current: 1 }));
  };
  var submit = function(e) {
    var _a2, _b2, _c2;
    (_a2 = e === null || e === void 0 ? void 0 : e.preventDefault) === null || _a2 === void 0 ? void 0 : _a2.call(e);
    _submit(runSuccessRef.current ? void 0 : __assign({ pageSize: options.defaultPageSize || ((_c2 = (_b2 = options.defaultParams) === null || _b2 === void 0 ? void 0 : _b2[0]) === null || _c2 === void 0 ? void 0 : _c2.pageSize) || 10, current: 1 }, (defaultParams === null || defaultParams === void 0 ? void 0 : defaultParams[0]) || {}));
  };
  var onTableChange = function(pagination, filters, sorter, extra) {
    ...
    run.apply(void 0, __spreadArray([__assign(__assign({}, oldPaginationParams), { current: pagination.current, pageSize: pagination.pageSize, filters, sorter, extra })], __read(restParams), false));
  };
...
var createEffectWithTarget = function(useEffectType) {
  var useEffectWithTarget3 = function(effect, deps, target) {
    ...
    var unLoadRef = (0, import_react22.useRef)(void 0);
...
var createDeepCompareEffect = function(hook) {
  return function(effect, deps) {
    var ref = (0, import_react31.useRef)(void 0);
...
var useDrag = function(data, target, options) {
  ...
  var imageElementRef = (0, import_react35.useRef)(void 0);
...
var useDrop = function(target, options) {
  ...
  var optionsRef = useLatest_default(options);
  var dragEnterTarget = (0, import_react36.useRef)(void 0);
  useEffectWithTarget_default(function() {
    var targetElement = getTargetElement(target);
    if (!(targetElement === null || targetElement === void 0 ? void 0 : targetElement.addEventListener)) {
      return;
...
var useDynamicList = function(initialList) {
  ...
  var setKey = (0, import_react37.useCallback)(function(index2) {
  ...
  var insert = (0, import_react37.useCallback)(function(index2, item) {
    setList(function(l) {
  ...
  var getKey = (0, import_react37.useCallback)(function(index2) {
  ...
  var merge = (0, import_react37.useCallback)(function(index2, items) {
    setList(function(l) {
      var temp = __spreadArray([], __read(l), false);
      items.forEach(function(_, i) {
        setKey(index2 + i);
      });
      temp.splice.apply(temp, __spreadArray([index2, 0], __read(items), false));
      return temp;
    });
  }, []);
  var replace = (0, import_react37.useCallback)(function(index2, item) {
    setList(function(l) {
      var temp = __spreadArray([], __read(l), false);
      temp[index2] = item;
      return temp;
  ...
  var remove = (0, import_react37.useCallback)(function(index2) {
    setList(function(l) {
      var temp = __spreadArray([], __read(l), false);
  ...
  var batchRemove = (0, import_react37.useCallback)(function(indexes) {
    ...
    setList(function(prevList) {
      var newKeyList = [];
      var newList = prevList.filter(function(item, index2) {
        var shouldKeep = !indexes.includes(index2);
        if (shouldKeep) {
  ...
  /* @__PURE__ */ function() {
    function EventEmitter2() {
      ...
      this.useSubscription = function(callback) {
        var callbackRef = (0, import_react38.useRef)(void 0);
...
function useEventEmitter() {
  var ref = (0, import_react38.useRef)(void 0);
  if (!ref.current) {
...
var useExternal = function(path, options) {
  ...
  var ref = (0, import_react40.useRef)(void 0);
...
var resultAdapter = function(result) {
  ...
  return __assign(__assign({}, result), { tableProps, paginationProps });
};
...
var useFusionTable = function(service, options) {
  ...
  var ret = useAntdTable_default(service, __assign(__assign({}, options), { form: options.field ? fieldAdapter(options.field) : void 0 }));
...
var useInfiniteScroll = function(service, options) {
  ...
  var lastScrollTop = (0, import_react46.useRef)(void 0);
  ...
  var _f = useRequest_default2(function(lastData) {
    ...
    onSuccess: function(d) {
      var _a2, _b2, _c2;
      if (!d.lastData) {
        setFinalData(__assign(__assign({}, d.currentData), { list: __spreadArray([], __read((_a2 = d.currentData.list) !== null && _a2 !== void 0 ? _a2 : []), false) }));
      } else {
        setFinalData(__assign(__assign({}, d.currentData), { list: isScrollToTop ? __spreadArray(__spreadArray([], __read(d.currentData.list), false), __read((_b2 = d.lastData.list) !== null && _b2 !== void 0 ? _b2 : []), false) : __spreadArray(__spreadArray([], __read((_c2 = d.lastData.list) !== null && _c2 !== void 0 ? _c2 : []), false), __read(d.currentData.list), false) }));
      }
      setTimeout(function() {
...
(function() {
  ...
  function IntersectionObserver2(callback, opt_options) {
    ...
    this._checkForIntersections = throttle4(
...
var useDeepCompareEffectWithTarget = function(effect, deps, target) {
  var ref = (0, import_react50.useRef)(void 0);
...
var createUseStorageState = function(getStorage) {
  var useStorageState = function(key, options) {
    ...
    var _b = __read((0, import_react51.useState)(getStoredValue), 2), state = _b[0], setState = _b[1];
    var stateRef = (0, import_react51.useRef)(state);
...
function useLongPress(onLongPress, target, _a) {
  ...
  var timerRef = (0, import_react53.useRef)(void 0);
  var isTriggeredRef = (0, import_react53.useRef)(false);
  var pervPositionRef = (0, import_react53.useRef)({ x: 0, y: 0 });
  var mousePressed = (0, import_react53.useRef)(false);
  var touchPressed = (0, import_react53.useRef)(false);
  ...
  useEffectWithTarget_default(function() {
    ...
    var onMouseUp = function(event) {
      ...
      if (isTriggeredRef.current) {
        (_b2 = onLongPressEndRef.current) === null || _b2 === void 0 ? void 0 : _b2.call(onLongPressEndRef, event);
      } else if (onClickRef.current) {
        onClickRef.current(event);
      }
      isTriggeredRef.current = false;
...
function useNetwork() {
  var _a = __read((0, import_react56.useState)(function() {
    return __assign({ since: void 0, online: navigator === null || navigator === void 0 ? void 0 : navigator.onLine }, getConnectionProperty());
  }), 2), state = _a[0], setState = _a[1];
  (0, import_react56.useEffect)(function() {
    var onOnline = function() {
      setState(function(prevState) {
        return __assign(__assign({}, prevState), { online: true, since: /* @__PURE__ */ new Date() });
      });
    };
    var onOffline = function() {
      setState(function(prevState) {
        return __assign(__assign({}, prevState), { online: false, since: /* @__PURE__ */ new Date() });
      });
    };
...
function usePrevious(state, shouldUpdate) {
  ...
  var prevRef = (0, import_react57.useRef)(void 0);
  var curRef = (0, import_react57.useRef)(void 0);
...
function useRafInterval(fn, delay, options) {
  ...
  var fnRef = useLatest_default(fn);
  var timerRef = (0, import_react58.useRef)(void 0);
...
var cancelAnimationFrameIsNotDefined2 = function(t) {
  return typeof cancelAnimationFrame === "undefined";
};
...
function useRafTimeout(fn, delay) {
  var fnRef = useLatest_default(fn);
  var timerRef = (0, import_react59.useRef)(void 0);
...
function useReactive(initialState) {
  ...
  var state = useCreation_default(function() {
...
var useResetState = function(initialState) {
  ...
  var initialStateMemo = useCreation_default(function() {
...
var initState2 = __assign({ text: "" }, initRect);
  ...
  useEffectWithTarget_default(function() {
    ...
    var mouseupHandler = function() {
      ...
      if (text && isInRangeRef.current) {
        ...
        setState(__assign(__assign(__assign({}, state), { text }), rect));
      }
    };
...
var useTrackedEffect = function(effect, deps) {
  var previousDepsRef = (0, import_react75.useRef)(void 0);
...
function useWebSocket(socketUrl, options) {
  ...
  var readyStateRef = useLatest_default(readyState);
  var reconnectTimesRef = (0, import_react78.useRef)(0);
  var reconnectTimerRef = (0, import_react78.useRef)(void 0);
  var websocketRef = (0, import_react78.useRef)(void 0);
...
export {
  ...
  useCreation_default as useCreation,
  ...
  useEventEmitter_default as useEventEmitter,
  ...
  useSelections_default as useSelections,
  ...
  useWhyDidYouUpdate_default as useWhyDidYouUpdate
};
