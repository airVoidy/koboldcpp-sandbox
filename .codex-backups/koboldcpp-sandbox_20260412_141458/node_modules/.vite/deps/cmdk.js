...
import {
  require_jsx_runtime
} from "./chunk-LYBC3WND.js";
import {
  require_react_dom
} from "./chunk-AZMVDGXN.js";
import {
  require_react
...
function createSlot2(ownerName) {
  ...
  const Slot22 = React27.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime7.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React27.isValidElement(newElement) ? React27.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime8.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React28.Children.map(children, (child) => (0, import_jsx_runtime8.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime8.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var DialogOverlayImpl = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    return (
      ...
      (0, import_jsx_runtime8.jsx)(Combination_default, { as: Slot3, allowPinchZoom: true, shards: [context.contentRef], children: (0, import_jsx_runtime8.jsx)(
        Primitive.div,
        {
          "data-state": getState(context.open),
          ...overlayProps,
