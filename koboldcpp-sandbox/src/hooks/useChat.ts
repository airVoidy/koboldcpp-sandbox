/**
 * useChat — chat state hook.
 *
 * All mutations go through exec CMD → server → refresh state.
 * No optimistic updates. Server = source of truth.
...
export function useChat() {
  ...
  // Init: show cached immediately, reconcile from server
  useEffect(() => {
